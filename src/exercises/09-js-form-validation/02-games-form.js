...
function onSubmitForm(evt) {
  ...
  } else if(!isMinLength(descriptionInput.value, descriptionMin)) {
    addError('description', `Description must be at least ${descriptionMin} characters long.`);
  }
